    ...
    private fun bottom_menu() {
        chipNavigationBar.setOnItemSelectedListener ({
            when (it) {
                ...
                R.id.menu_profile -> {
                    coordinator.setBackgroundColor(getColor(R.color.custom_color_secondary))
                    supportFragmentManager.beginTransaction().replace(R.id.root_layout, ProfileFragment()).commit()
                }
            }
        })
    }
